...
Route::get('shop/category/{id}', 'Frontend\ShopCategoryController@getproduct');
...
Route::prefix('admin')->group(function() {
    ...
    Route::get('shop/product/create', 'Admin\ShopProductController@create')->name('admin.get.create.product');
...
//    Route::get('shop/statistic', 'Admin\ContentCategoryController@index');
